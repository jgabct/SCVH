...
public class LoginController implements Initializable {
	...
	/*
	 * Nota: essa janela tem os botões fixos no fxml pq não sofrerá mudanças
	 */
	...
	@FXML
	private TextField employeeEnrolmentTextField;
	@FXML
	...
	private void toAssemble() {
		try {
			...
			/*
			 * Respons�vel por carregar o FXML e o CSS, assim criando a cena para o palco, o
			 * parametro serve para mostrar qual � o controller respons�vel pela cena
			 */
